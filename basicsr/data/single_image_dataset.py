...
if __name__ == '__main__':
    opt = {}
    opt["ckpt_path"] = "/home/intern/ztw/Methods/LatentDehazing/logs/2024-03-25T16-04-40_v2-finetune_text_T_512/checkpoints/epoch=000071.ckpt"
    opt['depth_path'] = "/home/intern/ztw/Data/RESIDE_new/HR_depth"
    opt['gt_path'] = "/home/intern/ztw/Data/RESIDE_new/HR"
    opt['ref_path'] = "/home/intern/ztw/Data/RESIDE_ours/HR_hazy_src"
    opt['config'] = "/home/intern/ztw/Methods/LatentDehazing/configs/LatentDehazing/v2-finetune_text_T_512.yaml"
    opt["io_backend"] =  {"type": "disk"}
    opt['use_hflip'] = True
    opt['use_rot'] = True

    print(opt)
    reside_set = SingleImageNPDataset(opt)
    print(reside_set)

    
    vutils.save_image(image['gt'],'/home/intern/ztw/Methods/LatentDehazing/test_data/gt/test_1_gt.png')
    vutils.save_image(image['hazy'],'/home/intern/ztw/Methods/LatentDehazing/test_data/hazy/test_1_hazy.png')
    vutils.save_image(image['sample'],'/home/intern/ztw/Methods/LatentDehazing/test_data/sample/test_1_sample.png')
