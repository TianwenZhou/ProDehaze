...
class FrozenOpenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, arch="ViT-H-14", version="/home/intern/ztw/ztw/ztw/Methods/LatentDehazing/src/open_clip/open_clip_pytorch_model.bin", device="cuda", max_length=77,
